...
### 2026-01-04: **UI 개선 및 온보딩 질문 구조 변경**
...
**4. WeekCalendar 일정 목록에서 절기 제외**
- 달력을 클릭했을 때 나오는 일정 목록에서 절기 제외
- 절기는 달력 칸 안에만 표시
- 수정 파일: `WeekCalendar.tsx` (line 93-104)

#### 진행 중인 작업 🚧
**5. 온보딩 질문 카테고리화**
- 8개 상위 카테고리 추가 (집착과 무자성, 발원과 수행 등)
- 카테고리별로 질문 그룹화하여 표시
- SQL 파일: `scraper/발원회향/practice_items_with_sections.sql` (Supabase 실행 필요)
- 수정 파일: `OnboardingView.tsx`
